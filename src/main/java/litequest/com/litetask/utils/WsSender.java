package litequest.com.litetask.utils;
...
import litequest.com.litetask.dto.WsEvnDto;
...
public class WsSender {
    ...
    public <T> BiConsumer<EventType, T> getSender(ObjectType objectType, Class view){
        ...
        return (EventType eventType,T payload)->{
            ...
            template.convertAndSend("/topic/activity",new WsEvnDto(objectType,eventType,value));
        };
    }
